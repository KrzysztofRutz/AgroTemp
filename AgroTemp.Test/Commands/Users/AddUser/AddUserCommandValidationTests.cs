...
public class AddUserCommandValidationTests
{
    private readonly Mock<IUserRepository> _userRepositoryMock;
    public AddUserCommandValidationTests()
    {
        _userRepositoryMock = new();
    }

    [Fact]
    public void ValidationResult_Should_Not_HaveAnyValidationErrors_WhenAddUserCommandIsValidated()
    {
        //Arrange 
        ...
        var validator = new AddUserCommandValidation();
