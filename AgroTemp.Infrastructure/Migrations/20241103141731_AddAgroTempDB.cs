    ...
    public partial class AddAgroTempDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeltaTemperatures", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeltaTemperatures_ReadingModules_ReadingModuleId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 11, 3, 15, 17, 31, 671, DateTimeKind.Local).AddTicks(4623), false, false, 24, 12, "ENG", new DateTime(2024, 11, 3, 15, 17, 31, 671, DateTimeKind.Local).AddTicks(4664) });

            migrationBuilder.CreateIndex(
                name: "IX_DeltaTemperatures_ReadingModuleId",
                table: "DeltaTemperatures",
